...
Gem::Specification.new do |s|
  ...
  s.summary     = "Integration API Ruby Gem"
  s.description = "This is a sample definition of the Oracle WMS Cloud Integration API.  The views expressed here are my own and do not necessarily reflect the views of Oracle."
  s.license     = "Unlicense"
