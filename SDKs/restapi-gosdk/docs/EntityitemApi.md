...
# **EntityItemByIdGET**
> interface{} EntityItemByIdGET(ctx, id, optional)
EntityItemById_GET
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **float32**|  | 
 **optional** | ***EntityitemApiEntityItemByIdGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntityitemApiEntityItemByIdGETOpts struct
...
> interface{} EntityItemDescribeGET(ctx, )
...
# **EntityItemGET**
> interface{} EntityItemGET(ctx, optional)
EntityItem_GET
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***EntityitemApiEntityItemGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntityitemApiEntityItemGETOpts struct
...
> interface{} EntityItemImageUploadByIdPOST(ctx, id)
...
> interface{} EntityItemImageUploadPOST(ctx, )
