...
> interface{} EntityLocationTypeByIdGET(ctx, id, optional)
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **float32**|  | 
 **optional** | ***EntitylocationTypeApiEntityLocationTypeByIdGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntitylocationTypeApiEntityLocationTypeByIdGETOpts struct
...
> interface{} EntityLocationTypeDescribeGET(ctx, )
...
> interface{} EntityLocationTypeGET(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***EntitylocationTypeApiEntityLocationTypeGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntitylocationTypeApiEntityLocationTypeGETOpts struct
