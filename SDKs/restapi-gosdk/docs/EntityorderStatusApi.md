...
> interface{} EntityOrderStatusByIdGET(ctx, id, optional)
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **float32**|  | 
 **optional** | ***EntityorderStatusApiEntityOrderStatusByIdGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntityorderStatusApiEntityOrderStatusByIdGETOpts struct
...
> interface{} EntityOrderStatusDescribeGET(ctx, )
...
> interface{} EntityOrderStatusGET(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***EntityorderStatusApiEntityOrderStatusGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntityorderStatusApiEntityOrderStatusGETOpts struct
