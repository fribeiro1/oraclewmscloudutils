...
> interface{} EntityTaskActivityByIdGET(ctx, id, optional)
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **float32**|  | 
 **optional** | ***EntitytaskActivityApiEntityTaskActivityByIdGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntitytaskActivityApiEntityTaskActivityByIdGETOpts struct
...
> interface{} EntityTaskActivityDescribeGET(ctx, )
...
> interface{} EntityTaskActivityGET(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***EntitytaskActivityApiEntityTaskActivityGETOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EntitytaskActivityApiEntityTaskActivityGETOpts struct
