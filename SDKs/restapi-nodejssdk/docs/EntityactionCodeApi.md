...
> Object entityActionCodeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityactionCodeApi();
...
apiInstance.entityActionCodeByIdGET(id, opts, callback);
```
...
apiInstance.entityActionCodeDescribeGET(callback);
```
...
# **entityActionCodeGET**
> Object entityActionCodeGET(opts)
...
apiInstance.entityActionCodeGET(opts, callback);
```
