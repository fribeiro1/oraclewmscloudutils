# RestApi.EntityactiveLocationApi
...
> Object entityActiveLocationByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityactiveLocationApi();
...
apiInstance.entityActiveLocationByIdGET(id, opts, callback);
```
...
> Object entityActiveLocationByIdPATCH(id, opts)
...
apiInstance.entityActiveLocationByIdPATCH(id, opts, callback);
```
...
apiInstance.entityActiveLocationDescribeGET(callback);
```
...
> Object entityActiveLocationGET(opts)
...
apiInstance.entityActiveLocationGET(opts, callback);
```
