...
> Object entityAllocationByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityallocationApi();
...
apiInstance.entityAllocationByIdGET(id, opts, callback);
```
...
apiInstance.entityAllocationDescribeGET(callback);
```
...
# **entityAllocationGET**
> Object entityAllocationGET(opts)
...
apiInstance.entityAllocationGET(opts, callback);
```
