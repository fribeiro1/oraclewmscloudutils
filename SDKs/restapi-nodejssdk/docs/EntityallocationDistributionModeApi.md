# RestApi.EntityallocationDistributionModeApi
...
> Object entityAllocationDistributionModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityallocationDistributionModeApi();
...
apiInstance.entityAllocationDistributionModeByIdGET(id, opts, callback);
```
...
apiInstance.entityAllocationDistributionModeDescribeGET(callback);
```
...
> Object entityAllocationDistributionModeGET(opts)
...
apiInstance.entityAllocationDistributionModeGET(opts, callback);
```
