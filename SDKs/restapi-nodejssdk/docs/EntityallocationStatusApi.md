# RestApi.EntityallocationStatusApi
...
> Object entityAllocationStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityallocationStatusApi();
...
apiInstance.entityAllocationStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityAllocationStatusDescribeGET(callback);
```
...
> Object entityAllocationStatusGET(opts)
...
apiInstance.entityAllocationStatusGET(opts, callback);
```
