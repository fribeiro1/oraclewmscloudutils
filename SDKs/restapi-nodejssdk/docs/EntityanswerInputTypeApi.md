# RestApi.EntityanswerInputTypeApi
...
> Object entityAnswerInputTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityanswerInputTypeApi();
...
apiInstance.entityAnswerInputTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityAnswerInputTypeDescribeGET(callback);
```
...
> Object entityAnswerInputTypeGET(opts)
...
apiInstance.entityAnswerInputTypeGET(opts, callback);
```
