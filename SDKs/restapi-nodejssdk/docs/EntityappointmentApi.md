...
> Object entityAppointmentByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityappointmentApi();
...
apiInstance.entityAppointmentByIdGET(id, opts, callback);
```
...
> Object entityAppointmentByIdPATCH(id, opts)
...
apiInstance.entityAppointmentByIdPATCH(id, opts, callback);
```
...
apiInstance.entityAppointmentDescribeGET(callback);
```
...
> Object entityAppointmentGET(opts)
...
apiInstance.entityAppointmentGET(opts, callback);
```
