# RestApi.EntityappointmentStatusApi
...
> Object entityAppointmentStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityappointmentStatusApi();
...
apiInstance.entityAppointmentStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityAppointmentStatusDescribeGET(callback);
```
...
> Object entityAppointmentStatusGET(opts)
...
apiInstance.entityAppointmentStatusGET(opts, callback);
```
