...
> Object entityAssetStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityassetStatusApi();
...
apiInstance.entityAssetStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityAssetStatusDescribeGET(callback);
```
...
> Object entityAssetStatusGET(opts)
...
apiInstance.entityAssetStatusGET(opts, callback);
```
