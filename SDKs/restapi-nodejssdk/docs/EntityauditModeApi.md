...
> Object entityAuditModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityauditModeApi();
...
apiInstance.entityAuditModeByIdGET(id, opts, callback);
```
...
apiInstance.entityAuditModeDescribeGET(callback);
```
...
# **entityAuditModeGET**
> Object entityAuditModeGET(opts)
...
apiInstance.entityAuditModeGET(opts, callback);
```
