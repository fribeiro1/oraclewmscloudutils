...
> Object entityAuditStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityauditStatusApi();
...
apiInstance.entityAuditStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityAuditStatusDescribeGET(callback);
```
...
> Object entityAuditStatusGET(opts)
...
apiInstance.entityAuditStatusGET(opts, callback);
```
