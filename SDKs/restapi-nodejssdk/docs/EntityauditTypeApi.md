...
> Object entityAuditTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityauditTypeApi();
...
apiInstance.entityAuditTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityAuditTypeDescribeGET(callback);
```
...
# **entityAuditTypeGET**
> Object entityAuditTypeGET(opts)
...
apiInstance.entityAuditTypeGET(opts, callback);
```
