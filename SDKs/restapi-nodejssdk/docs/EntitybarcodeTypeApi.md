...
> Object entityBarcodeTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitybarcodeTypeApi();
...
apiInstance.entityBarcodeTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityBarcodeTypeDescribeGET(callback);
```
...
> Object entityBarcodeTypeGET(opts)
...
apiInstance.entityBarcodeTypeGET(opts, callback);
```
