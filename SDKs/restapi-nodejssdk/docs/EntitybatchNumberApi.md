...
> Object entityBatchNumberByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitybatchNumberApi();
...
apiInstance.entityBatchNumberByIdGET(id, opts, callback);
```
...
apiInstance.entityBatchNumberDescribeGET(callback);
```
...
> Object entityBatchNumberGET(opts)
...
apiInstance.entityBatchNumberGET(opts, callback);
```
...
> Object entityBatchNumberPOST(opts)
...
apiInstance.entityBatchNumberPOST(opts, callback);
```
