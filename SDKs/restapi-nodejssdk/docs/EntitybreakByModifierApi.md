# RestApi.EntitybreakByModifierApi
...
> Object entityBreakByModifierByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitybreakByModifierApi();
...
apiInstance.entityBreakByModifierByIdGET(id, opts, callback);
```
...
apiInstance.entityBreakByModifierDescribeGET(callback);
```
...
> Object entityBreakByModifierGET(opts)
...
apiInstance.entityBreakByModifierGET(opts, callback);
```
