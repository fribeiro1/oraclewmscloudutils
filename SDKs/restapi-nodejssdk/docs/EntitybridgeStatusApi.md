...
> Object entityBridgeStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitybridgeStatusApi();
...
apiInstance.entityBridgeStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityBridgeStatusDescribeGET(callback);
```
...
> Object entityBridgeStatusGET(opts)
...
apiInstance.entityBridgeStatusGET(opts, callback);
```
