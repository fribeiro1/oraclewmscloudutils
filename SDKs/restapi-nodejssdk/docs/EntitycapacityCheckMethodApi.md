# RestApi.EntitycapacityCheckMethodApi
...
> Object entityCapacityCheckMethodByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycapacityCheckMethodApi();
...
apiInstance.entityCapacityCheckMethodByIdGET(id, opts, callback);
```
...
apiInstance.entityCapacityCheckMethodDescribeGET(callback);
```
...
> Object entityCapacityCheckMethodGET(opts)
...
apiInstance.entityCapacityCheckMethodGET(opts, callback);
```
