# RestApi.EntitycarrierIntegrationTypeApi
...
> Object entityCarrierIntegrationTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycarrierIntegrationTypeApi();
...
apiInstance.entityCarrierIntegrationTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityCarrierIntegrationTypeDescribeGET(callback);
```
...
> Object entityCarrierIntegrationTypeGET(opts)
...
apiInstance.entityCarrierIntegrationTypeGET(opts, callback);
```
