...
> Object entityCarrierLpnByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycarrierLpnApi();
...
apiInstance.entityCarrierLpnByIdGET(id, opts, callback);
```
...
apiInstance.entityCarrierLpnDescribeGET(callback);
```
...
# **entityCarrierLpnGET**
> Object entityCarrierLpnGET(opts)
...
apiInstance.entityCarrierLpnGET(opts, callback);
```
