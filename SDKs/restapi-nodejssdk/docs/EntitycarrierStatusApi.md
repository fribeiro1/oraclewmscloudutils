# RestApi.EntitycarrierStatusApi
...
> Object entityCarrierStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycarrierStatusApi();
...
apiInstance.entityCarrierStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityCarrierStatusDescribeGET(callback);
```
...
> Object entityCarrierStatusGET(opts)
...
apiInstance.entityCarrierStatusGET(opts, callback);
```
