...
> Object entityCarrierTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycarrierTypeApi();
...
apiInstance.entityCarrierTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityCarrierTypeDescribeGET(callback);
```
...
> Object entityCarrierTypeGET(opts)
...
apiInstance.entityCarrierTypeGET(opts, callback);
```
