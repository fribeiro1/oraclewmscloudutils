# RestApi.EntityccAdjustmentStatusApi
...
> Object entityCcAdjustmentStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityccAdjustmentStatusApi();
...
apiInstance.entityCcAdjustmentStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityCcAdjustmentStatusDescribeGET(callback);
```
...
> Object entityCcAdjustmentStatusGET(opts)
...
apiInstance.entityCcAdjustmentStatusGET(opts, callback);
```
