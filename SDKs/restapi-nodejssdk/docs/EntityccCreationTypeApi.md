# RestApi.EntityccCreationTypeApi
...
> Object entityCcCreationTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityccCreationTypeApi();
...
apiInstance.entityCcCreationTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityCcCreationTypeDescribeGET(callback);
```
...
> Object entityCcCreationTypeGET(opts)
...
apiInstance.entityCcCreationTypeGET(opts, callback);
```
