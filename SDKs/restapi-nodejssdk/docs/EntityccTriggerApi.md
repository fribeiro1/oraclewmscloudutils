...
> Object entityCcTriggerByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityccTriggerApi();
...
apiInstance.entityCcTriggerByIdGET(id, opts, callback);
```
...
apiInstance.entityCcTriggerDescribeGET(callback);
```
...
# **entityCcTriggerGET**
> Object entityCcTriggerGET(opts)
...
apiInstance.entityCcTriggerGET(opts, callback);
```
