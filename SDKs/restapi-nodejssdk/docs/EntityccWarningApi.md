...
> Object entityCcWarningByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityccWarningApi();
...
apiInstance.entityCcWarningByIdGET(id, opts, callback);
```
...
apiInstance.entityCcWarningDescribeGET(callback);
```
...
# **entityCcWarningGET**
> Object entityCcWarningGET(opts)
...
apiInstance.entityCcWarningGET(opts, callback);
```
