# RestApi.EntitycheckDigitMethodApi
...
> Object entityCheckDigitMethodByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycheckDigitMethodApi();
...
apiInstance.entityCheckDigitMethodByIdGET(id, opts, callback);
```
...
apiInstance.entityCheckDigitMethodDescribeGET(callback);
```
...
> Object entityCheckDigitMethodGET(opts)
...
apiInstance.entityCheckDigitMethodGET(opts, callback);
```
