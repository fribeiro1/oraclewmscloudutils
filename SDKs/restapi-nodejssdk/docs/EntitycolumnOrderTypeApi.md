# RestApi.EntitycolumnOrderTypeApi
...
> Object entityColumnOrderTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycolumnOrderTypeApi();
...
apiInstance.entityColumnOrderTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityColumnOrderTypeDescribeGET(callback);
```
...
> Object entityColumnOrderTypeGET(opts)
...
apiInstance.entityColumnOrderTypeGET(opts, callback);
```
