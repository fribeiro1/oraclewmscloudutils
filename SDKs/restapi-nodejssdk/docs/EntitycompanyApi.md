...
> Object entityCompanyByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycompanyApi();
...
apiInstance.entityCompanyByIdGET(id, opts, callback);
```
...
> Object entityCompanyByIdPATCH(id, opts)
...
apiInstance.entityCompanyByIdPATCH(id, opts, callback);
```
...
apiInstance.entityCompanyDescribeGET(callback);
```
...
apiInstance.entityCompanyGET(opts, callback);
```
