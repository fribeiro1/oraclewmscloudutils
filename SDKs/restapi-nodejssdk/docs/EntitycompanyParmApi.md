...
> Object entityCompanyParmByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycompanyParmApi();
...
apiInstance.entityCompanyParmByIdGET(id, opts, callback);
```
...
apiInstance.entityCompanyParmDescribeGET(callback);
```
...
> Object entityCompanyParmGET(opts)
...
apiInstance.entityCompanyParmGET(opts, callback);
```
...
> Object entityCompanyParmPOST(opts)
...
apiInstance.entityCompanyParmPOST(opts, callback);
```
