...
> Object entityCompanyTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycompanyTypeApi();
...
apiInstance.entityCompanyTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityCompanyTypeDescribeGET(callback);
```
...
> Object entityCompanyTypeGET(opts)
...
apiInstance.entityCompanyTypeGET(opts, callback);
```
