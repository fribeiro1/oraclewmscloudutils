# RestApi.EntityconditionTypeApi
...
> Object entityConditionTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityconditionTypeApi();
...
apiInstance.entityConditionTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityConditionTypeDescribeGET(callback);
```
...
> Object entityConditionTypeGET(opts)
...
apiInstance.entityConditionTypeGET(opts, callback);
```
