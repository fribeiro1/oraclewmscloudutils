...
> Object entityContactByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycontactApi();
...
apiInstance.entityContactByIdGET(id, opts, callback);
```
...
apiInstance.entityContactDescribeGET(callback);
```
...
apiInstance.entityContactGET(opts, callback);
```
