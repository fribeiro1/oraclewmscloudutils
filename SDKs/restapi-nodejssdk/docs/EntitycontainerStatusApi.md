# RestApi.EntitycontainerStatusApi
...
> Object entityContainerStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycontainerStatusApi();
...
apiInstance.entityContainerStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityContainerStatusDescribeGET(callback);
```
...
> Object entityContainerStatusGET(opts)
...
apiInstance.entityContainerStatusGET(opts, callback);
```
