# RestApi.EntitycontainerVasStatusApi
...
> Object entityContainerVasStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycontainerVasStatusApi();
...
apiInstance.entityContainerVasStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityContainerVasStatusDescribeGET(callback);
```
...
> Object entityContainerVasStatusGET(opts)
...
apiInstance.entityContainerVasStatusGET(opts, callback);
```
