...
> Object entityCubingModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitycubingModeApi();
...
apiInstance.entityCubingModeByIdGET(id, opts, callback);
```
...
apiInstance.entityCubingModeDescribeGET(callback);
```
...
# **entityCubingModeGET**
> Object entityCubingModeGET(opts)
...
apiInstance.entityCubingModeGET(opts, callback);
```
