...
> Object entityDateFormatByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitydateFormatApi();
...
apiInstance.entityDateFormatByIdGET(id, opts, callback);
```
...
apiInstance.entityDateFormatDescribeGET(callback);
```
...
# **entityDateFormatGET**
> Object entityDateFormatGET(opts)
...
apiInstance.entityDateFormatGET(opts, callback);
```
