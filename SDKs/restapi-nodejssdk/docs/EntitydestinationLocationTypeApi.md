# RestApi.EntitydestinationLocationTypeApi
...
> Object entityDestinationLocationTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitydestinationLocationTypeApi();
...
apiInstance.entityDestinationLocationTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityDestinationLocationTypeDescribeGET(callback);
```
...
> Object entityDestinationLocationTypeGET(opts)
...
apiInstance.entityDestinationLocationTypeGET(opts, callback);
```
