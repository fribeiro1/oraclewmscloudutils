...
# **entityDockByIdGET**
> Object entityDockByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitydockApi();
...
apiInstance.entityDockByIdGET(id, opts, callback);
```
...
apiInstance.entityDockDescribeGET(callback);
```
...
apiInstance.entityDockGET(opts, callback);
```
