...
> Object entityDockStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitydockStatusApi();
...
apiInstance.entityDockStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityDockStatusDescribeGET(callback);
```
...
# **entityDockStatusGET**
> Object entityDockStatusGET(opts)
...
apiInstance.entityDockStatusGET(opts, callback);
```
