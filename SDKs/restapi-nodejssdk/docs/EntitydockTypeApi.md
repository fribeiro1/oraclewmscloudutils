...
> Object entityDockTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitydockTypeApi();
...
apiInstance.entityDockTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityDockTypeDescribeGET(callback);
```
...
apiInstance.entityDockTypeGET(opts, callback);
```
