# RestApi.EntityentityChangeActionApi
...
> Object entityEntityChangeActionByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityentityChangeActionApi();
...
apiInstance.entityEntityChangeActionByIdGET(id, opts, callback);
```
...
apiInstance.entityEntityChangeActionDescribeGET(callback);
```
...
> Object entityEntityChangeActionGET(opts)
...
apiInstance.entityEntityChangeActionGET(opts, callback);
```
