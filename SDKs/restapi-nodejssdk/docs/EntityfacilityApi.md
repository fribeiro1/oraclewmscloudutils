...
> Object entityFacilityByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityfacilityApi();
...
apiInstance.entityFacilityByIdGET(id, opts, callback);
```
...
> Object entityFacilityByIdPATCH(id, opts)
...
apiInstance.entityFacilityByIdPATCH(id, opts, callback);
```
...
apiInstance.entityFacilityDescribeGET(callback);
```
...
apiInstance.entityFacilityGET(opts, callback);
```
