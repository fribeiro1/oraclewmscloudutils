...
> Object entityFacilityParmByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityfacilityParmApi();
...
apiInstance.entityFacilityParmByIdGET(id, opts, callback);
```
...
apiInstance.entityFacilityParmDescribeGET(callback);
```
...
> Object entityFacilityParmGET(opts)
...
apiInstance.entityFacilityParmGET(opts, callback);
```
...
> Object entityFacilityParmPOST(opts)
...
apiInstance.entityFacilityParmPOST(opts, callback);
```
