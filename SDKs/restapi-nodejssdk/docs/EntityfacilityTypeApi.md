...
> Object entityFacilityTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityfacilityTypeApi();
...
apiInstance.entityFacilityTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityFacilityTypeDescribeGET(callback);
```
...
> Object entityFacilityTypeGET(opts)
...
apiInstance.entityFacilityTypeGET(opts, callback);
```
