...
> Object entityFormTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityformTypeApi();
...
apiInstance.entityFormTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityFormTypeDescribeGET(callback);
```
...
apiInstance.entityFormTypeGET(opts, callback);
```
