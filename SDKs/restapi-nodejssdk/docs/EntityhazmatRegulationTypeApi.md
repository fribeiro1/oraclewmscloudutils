# RestApi.EntityhazmatRegulationTypeApi
...
> Object entityHazmatRegulationTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityhazmatRegulationTypeApi();
...
apiInstance.entityHazmatRegulationTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityHazmatRegulationTypeDescribeGET(callback);
```
...
> Object entityHazmatRegulationTypeGET(opts)
...
apiInstance.entityHazmatRegulationTypeGET(opts, callback);
```
