# RestApi.EntityibShipmentDtlApi
...
> Object entityIbShipmentDtlByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityibShipmentDtlApi();
...
apiInstance.entityIbShipmentDtlByIdGET(id, opts, callback);
```
...
> Object entityIbShipmentDtlByIdPATCH(id, opts)
...
apiInstance.entityIbShipmentDtlByIdPATCH(id, opts, callback);
```
...
apiInstance.entityIbShipmentDtlDescribeGET(callback);
```
...
> Object entityIbShipmentDtlGET(opts)
...
apiInstance.entityIbShipmentDtlGET(opts, callback);
```
