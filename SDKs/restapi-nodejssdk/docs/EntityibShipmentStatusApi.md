# RestApi.EntityibShipmentStatusApi
...
> Object entityIbShipmentStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityibShipmentStatusApi();
...
apiInstance.entityIbShipmentStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityIbShipmentStatusDescribeGET(callback);
```
...
> Object entityIbShipmentStatusGET(opts)
...
apiInstance.entityIbShipmentStatusGET(opts, callback);
```
