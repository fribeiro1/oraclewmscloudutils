# RestApi.EntityinterfaceFormatTypeApi
...
> Object entityInterfaceFormatTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinterfaceFormatTypeApi();
...
apiInstance.entityInterfaceFormatTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityInterfaceFormatTypeDescribeGET(callback);
```
...
> Object entityInterfaceFormatTypeGET(opts)
...
apiInstance.entityInterfaceFormatTypeGET(opts, callback);
```
