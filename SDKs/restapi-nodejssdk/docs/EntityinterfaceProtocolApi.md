# RestApi.EntityinterfaceProtocolApi
...
> Object entityInterfaceProtocolByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinterfaceProtocolApi();
...
apiInstance.entityInterfaceProtocolByIdGET(id, opts, callback);
```
...
apiInstance.entityInterfaceProtocolDescribeGET(callback);
```
...
> Object entityInterfaceProtocolGET(opts)
...
apiInstance.entityInterfaceProtocolGET(opts, callback);
```
