# RestApi.EntityinterfaceTypeApi
...
> Object entityInterfaceTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinterfaceTypeApi();
...
apiInstance.entityInterfaceTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityInterfaceTypeDescribeGET(callback);
```
...
> Object entityInterfaceTypeGET(opts)
...
apiInstance.entityInterfaceTypeGET(opts, callback);
```
