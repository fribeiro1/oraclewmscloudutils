...
var apiInstance = new RestApi.EntityinventoryApi();
...
apiInstance.entityInventoryBulkUpdateInventoryAttributesPOST(callback);
```
...
> Object entityInventoryByIdGET(id, opts)
...
apiInstance.entityInventoryByIdGET(id, opts, callback);
```
...
apiInstance.entityInventoryDescribeGET(callback);
```
...
# **entityInventoryGET**
> Object entityInventoryGET(opts)
...
apiInstance.entityInventoryGET(opts, callback);
```
...
apiInstance.entityInventoryLinkSerialNbrsByIdPOST(id, callback);
```
...
# **entityInventoryPOST**
> Object entityInventoryPOST(opts)
...
apiInstance.entityInventoryPOST(opts, callback);
```
