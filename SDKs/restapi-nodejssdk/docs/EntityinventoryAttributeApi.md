# RestApi.EntityinventoryAttributeApi
...
> Object entityInventoryAttributeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinventoryAttributeApi();
...
apiInstance.entityInventoryAttributeByIdGET(id, opts, callback);
```
...
apiInstance.entityInventoryAttributeDescribeGET(callback);
```
...
> Object entityInventoryAttributeGET(opts)
...
apiInstance.entityInventoryAttributeGET(opts, callback);
```
...
> Object entityInventoryAttributePOST(opts)
...
apiInstance.entityInventoryAttributePOST(opts, callback);
```
