# RestApi.EntityinventoryLockApi
...
> Object entityInventoryLockByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinventoryLockApi();
...
apiInstance.entityInventoryLockByIdGET(id, opts, callback);
```
...
apiInstance.entityInventoryLockDescribeGET(callback);
```
...
> Object entityInventoryLockGET(opts)
...
apiInstance.entityInventoryLockGET(opts, callback);
```
...
> Object entityInventoryLockPOST(opts)
...
apiInstance.entityInventoryLockPOST(opts, callback);
```
