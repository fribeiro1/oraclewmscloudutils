# RestApi.EntityinventoryStatusApi
...
> Object entityInventoryStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinventoryStatusApi();
...
apiInstance.entityInventoryStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityInventoryStatusDescribeGET(callback);
```
...
> Object entityInventoryStatusGET(opts)
...
apiInstance.entityInventoryStatusGET(opts, callback);
```
