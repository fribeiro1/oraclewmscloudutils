# RestApi.EntityinvoiceStatusApi
...
> Object entityInvoiceStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityinvoiceStatusApi();
...
apiInstance.entityInvoiceStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityInvoiceStatusDescribeGET(callback);
```
...
> Object entityInvoiceStatusGET(opts)
...
apiInstance.entityInvoiceStatusGET(opts, callback);
```
