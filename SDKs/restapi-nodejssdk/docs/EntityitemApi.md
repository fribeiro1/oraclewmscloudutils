...
# **entityItemByIdGET**
> Object entityItemByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityitemApi();
...
apiInstance.entityItemByIdGET(id, opts, callback);
```
...
apiInstance.entityItemDescribeGET(callback);
```
...
apiInstance.entityItemGET(opts, callback);
```
...
apiInstance.entityItemImageUploadByIdPOST(id, callback);
```
...
apiInstance.entityItemImageUploadPOST(callback);
```
