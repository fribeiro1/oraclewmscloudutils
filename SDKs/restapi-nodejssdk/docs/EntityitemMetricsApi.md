...
> Object entityItemMetricsByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityitemMetricsApi();
...
apiInstance.entityItemMetricsByIdGET(id, opts, callback);
```
...
apiInstance.entityItemMetricsDescribeGET(callback);
```
...
> Object entityItemMetricsGET(opts)
...
apiInstance.entityItemMetricsGET(opts, callback);
```
