...
> Object entityLabelTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitylabelTypeApi();
...
apiInstance.entityLabelTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityLabelTypeDescribeGET(callback);
```
...
# **entityLabelTypeGET**
> Object entityLabelTypeGET(opts)
...
apiInstance.entityLabelTypeGET(opts, callback);
```
