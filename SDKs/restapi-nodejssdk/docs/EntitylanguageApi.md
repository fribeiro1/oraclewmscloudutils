...
> Object entityLanguageByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitylanguageApi();
...
apiInstance.entityLanguageByIdGET(id, opts, callback);
```
...
apiInstance.entityLanguageDescribeGET(callback);
```
...
apiInstance.entityLanguageGET(opts, callback);
```
