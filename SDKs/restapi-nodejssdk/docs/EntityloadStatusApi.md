...
> Object entityLoadStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityloadStatusApi();
...
apiInstance.entityLoadStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityLoadStatusDescribeGET(callback);
```
...
# **entityLoadStatusGET**
> Object entityLoadStatusGET(opts)
...
apiInstance.entityLoadStatusGET(opts, callback);
```
