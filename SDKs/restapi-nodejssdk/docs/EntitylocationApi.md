...
> Object entityLocationByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitylocationApi();
...
apiInstance.entityLocationByIdGET(id, opts, callback);
```
...
> Object entityLocationByIdPATCH(id, opts)
...
apiInstance.entityLocationByIdPATCH(id, opts, callback);
```
...
apiInstance.entityLocationDescribeGET(callback);
```
...
apiInstance.entityLocationGET(opts, callback);
```
...
apiInstance.entityLocationUpdateActiveInventoryByIdPOST(id, callback);
```
...
apiInstance.entityLocationUpdateActiveInventoryPOST(callback);
```
...
> Object entityLocationYearFirstAvailableGET(opts)
...
var opts = { 
  'facilityId': "facilityId_example", // String | 
...
apiInstance.entityLocationYearFirstAvailableGET(opts, callback);
```
