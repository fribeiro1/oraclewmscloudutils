# RestApi.EntitylocationSizeTypeApi
...
> Object entityLocationSizeTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitylocationSizeTypeApi();
...
apiInstance.entityLocationSizeTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityLocationSizeTypeGET(callback);
```
...
apiInstance.entityLocationSizeTypePOST(callback);
```
