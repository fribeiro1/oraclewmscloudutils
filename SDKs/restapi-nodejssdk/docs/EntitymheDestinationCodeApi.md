# RestApi.EntitymheDestinationCodeApi
...
> Object entityMheDestinationCodeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitymheDestinationCodeApi();
...
apiInstance.entityMheDestinationCodeByIdGET(id, opts, callback);
```
...
apiInstance.entityMheDestinationCodeDescribeGET(callback);
```
...
> Object entityMheDestinationCodeGET(opts)
...
apiInstance.entityMheDestinationCodeGET(opts, callback);
```
