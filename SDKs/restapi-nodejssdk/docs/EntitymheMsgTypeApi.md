...
> Object entityMheMsgTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitymheMsgTypeApi();
...
apiInstance.entityMheMsgTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityMheMsgTypeDescribeGET(callback);
```
...
# **entityMheMsgTypeGET**
> Object entityMheMsgTypeGET(opts)
...
apiInstance.entityMheMsgTypeGET(opts, callback);
```
