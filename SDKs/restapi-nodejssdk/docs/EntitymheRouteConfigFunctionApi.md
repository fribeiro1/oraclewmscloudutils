# RestApi.EntitymheRouteConfigFunctionApi
...
> Object entityMheRouteConfigFunctionByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitymheRouteConfigFunctionApi();
...
apiInstance.entityMheRouteConfigFunctionByIdGET(id, opts, callback);
```
...
apiInstance.entityMheRouteConfigFunctionDescribeGET(callback);
```
...
> Object entityMheRouteConfigFunctionGET(opts)
...
apiInstance.entityMheRouteConfigFunctionGET(opts, callback);
```
