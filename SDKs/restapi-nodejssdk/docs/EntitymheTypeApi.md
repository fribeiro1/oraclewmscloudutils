...
> Object entityMheTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitymheTypeApi();
...
apiInstance.entityMheTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityMheTypeDescribeGET(callback);
```
...
apiInstance.entityMheTypeGET(opts, callback);
```
