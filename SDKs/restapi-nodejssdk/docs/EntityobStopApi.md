...
# **entityObStopByIdGET**
> Object entityObStopByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityobStopApi();
...
apiInstance.entityObStopByIdGET(id, opts, callback);
```
...
apiInstance.entityObStopDescribeGET(callback);
```
...
apiInstance.entityObStopGET(opts, callback);
```
