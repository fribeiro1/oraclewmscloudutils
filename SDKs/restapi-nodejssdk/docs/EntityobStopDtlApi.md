...
> Object entityObStopDtlByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityobStopDtlApi();
...
apiInstance.entityObStopDtlByIdGET(id, opts, callback);
```
...
apiInstance.entityObStopDtlDescribeGET(callback);
```
...
# **entityObStopDtlGET**
> Object entityObStopDtlGET(opts)
...
apiInstance.entityObStopDtlGET(opts, callback);
```
