...
> Object entityOrderDtlByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityorderDtlApi();
...
apiInstance.entityOrderDtlByIdGET(id, opts, callback);
```
...
> Object entityOrderDtlByIdPATCH(id, opts)
...
apiInstance.entityOrderDtlByIdPATCH(id, opts, callback);
```
...
apiInstance.entityOrderDtlDescribeGET(callback);
```
...
apiInstance.entityOrderDtlGET(opts, callback);
```
