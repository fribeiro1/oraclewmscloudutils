# RestApi.EntityorderInstructionApi
...
> Object entityOrderInstructionByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityorderInstructionApi();
...
apiInstance.entityOrderInstructionByIdGET(id, opts, callback);
```
...
apiInstance.entityOrderInstructionDescribeGET(callback);
```
...
> Object entityOrderInstructionGET(opts)
...
apiInstance.entityOrderInstructionGET(opts, callback);
```
