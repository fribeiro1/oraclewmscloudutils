# RestApi.EntityorderInstructionTypeApi
...
> Object entityOrderInstructionTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityorderInstructionTypeApi();
...
apiInstance.entityOrderInstructionTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityOrderInstructionTypeDescribeGET(callback);
```
...
> Object entityOrderInstructionTypeGET(opts)
...
apiInstance.entityOrderInstructionTypeGET(opts, callback);
```
