...
> Object entityOrderLockByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityorderLockApi();
...
apiInstance.entityOrderLockByIdGET(id, opts, callback);
```
...
apiInstance.entityOrderLockDescribeGET(callback);
```
...
# **entityOrderLockGET**
> Object entityOrderLockGET(opts)
...
apiInstance.entityOrderLockGET(opts, callback);
```
