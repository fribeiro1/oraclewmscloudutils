...
> Object entityOrderTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityorderTypeApi();
...
apiInstance.entityOrderTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityOrderTypeDescribeGET(callback);
```
...
# **entityOrderTypeGET**
> Object entityOrderTypeGET(opts)
...
apiInstance.entityOrderTypeGET(opts, callback);
```
