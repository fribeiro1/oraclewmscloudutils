# RestApi.EntityorderValidationModeApi
...
> Object entityOrderValidationModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityorderValidationModeApi();
...
apiInstance.entityOrderValidationModeByIdGET(id, opts, callback);
```
...
apiInstance.entityOrderValidationModeDescribeGET(callback);
```
...
> Object entityOrderValidationModeGET(opts)
...
apiInstance.entityOrderValidationModeGET(opts, callback);
```
