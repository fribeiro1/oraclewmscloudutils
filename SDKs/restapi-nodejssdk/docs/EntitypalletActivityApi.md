# RestApi.EntitypalletActivityApi
...
> Object entityPalletActivityByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypalletActivityApi();
...
apiInstance.entityPalletActivityByIdGET(id, opts, callback);
```
...
apiInstance.entityPalletActivityDescribeGET(callback);
```
...
> Object entityPalletActivityGET(opts)
...
apiInstance.entityPalletActivityGET(opts, callback);
```
