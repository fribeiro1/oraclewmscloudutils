...
# **entityPalletByIdGET**
> Object entityPalletByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypalletApi();
...
apiInstance.entityPalletByIdGET(id, opts, callback);
```
...
apiInstance.entityPalletCloseInboundSortingByIdPOST(id, callback);
```
...
apiInstance.entityPalletCloseInboundSortingPOST(callback);
```
...
apiInstance.entityPalletDescribeGET(callback);
```
...
apiInstance.entityPalletGET(opts, callback);
```
...
apiInstance.entityPalletSortLpnPOST(callback);
```
