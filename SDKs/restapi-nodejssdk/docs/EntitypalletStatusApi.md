...
> Object entityPalletStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypalletStatusApi();
...
apiInstance.entityPalletStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityPalletStatusDescribeGET(callback);
```
...
> Object entityPalletStatusGET(opts)
...
apiInstance.entityPalletStatusGET(opts, callback);
```
