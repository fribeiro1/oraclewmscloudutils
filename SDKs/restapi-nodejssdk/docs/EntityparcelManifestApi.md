# RestApi.EntityparcelManifestApi
...
> Object entityParcelManifestByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityparcelManifestApi();
...
apiInstance.entityParcelManifestByIdGET(id, opts, callback);
```
...
apiInstance.entityParcelManifestDescribeGET(callback);
```
...
> Object entityParcelManifestGET(opts)
...
apiInstance.entityParcelManifestGET(opts, callback);
```
