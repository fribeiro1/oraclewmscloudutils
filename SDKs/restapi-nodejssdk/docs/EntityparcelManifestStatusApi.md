# RestApi.EntityparcelManifestStatusApi
...
> Object entityParcelManifestStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityparcelManifestStatusApi();
...
apiInstance.entityParcelManifestStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityParcelManifestStatusDescribeGET(callback);
```
...
> Object entityParcelManifestStatusGET(opts)
...
apiInstance.entityParcelManifestStatusGET(opts, callback);
```
