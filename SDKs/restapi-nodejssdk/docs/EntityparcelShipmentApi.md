# RestApi.EntityparcelShipmentApi
...
> Object entityParcelShipmentByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityparcelShipmentApi();
...
apiInstance.entityParcelShipmentByIdGET(id, opts, callback);
```
...
apiInstance.entityParcelShipmentDescribeGET(callback);
```
...
> Object entityParcelShipmentGET(opts)
...
apiInstance.entityParcelShipmentGET(opts, callback);
```
