# RestApi.EntityparcelShipmentDtlApi
...
> Object entityParcelShipmentDtlByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityparcelShipmentDtlApi();
...
apiInstance.entityParcelShipmentDtlByIdGET(id, opts, callback);
```
...
apiInstance.entityParcelShipmentDtlDescribeGET(callback);
```
...
> Object entityParcelShipmentDtlGET(opts)
...
apiInstance.entityParcelShipmentDtlGET(opts, callback);
```
