...
> Object entityParmTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityparmTypeApi();
...
apiInstance.entityParmTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityParmTypeDescribeGET(callback);
```
...
apiInstance.entityParmTypeGET(opts, callback);
```
