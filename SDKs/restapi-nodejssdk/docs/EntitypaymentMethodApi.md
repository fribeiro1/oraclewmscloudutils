# RestApi.EntitypaymentMethodApi
...
> Object entityPaymentMethodByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypaymentMethodApi();
...
apiInstance.entityPaymentMethodByIdGET(id, opts, callback);
```
...
apiInstance.entityPaymentMethodDescribeGET(callback);
```
...
> Object entityPaymentMethodGET(opts)
...
apiInstance.entityPaymentMethodGET(opts, callback);
```
