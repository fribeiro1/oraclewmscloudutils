...
> Object entityPrinterByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityprinterApi();
...
apiInstance.entityPrinterByIdGET(id, opts, callback);
```
...
apiInstance.entityPrinterDescribeGET(callback);
```
...
apiInstance.entityPrinterGET(opts, callback);
```
