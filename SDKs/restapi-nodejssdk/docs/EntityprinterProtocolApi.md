# RestApi.EntityprinterProtocolApi
...
> Object entityPrinterProtocolByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityprinterProtocolApi();
...
apiInstance.entityPrinterProtocolByIdGET(id, opts, callback);
```
...
apiInstance.entityPrinterProtocolDescribeGET(callback);
```
...
> Object entityPrinterProtocolGET(opts)
...
apiInstance.entityPrinterProtocolGET(opts, callback);
```
