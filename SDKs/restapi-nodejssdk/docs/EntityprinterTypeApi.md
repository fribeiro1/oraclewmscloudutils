...
> Object entityPrinterTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityprinterTypeApi();
...
apiInstance.entityPrinterTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityPrinterTypeDescribeGET(callback);
```
...
> Object entityPrinterTypeGET(opts)
...
apiInstance.entityPrinterTypeGET(opts, callback);
```
