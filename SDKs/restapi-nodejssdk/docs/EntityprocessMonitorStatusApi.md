# RestApi.EntityprocessMonitorStatusApi
...
> Object entityProcessMonitorStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityprocessMonitorStatusApi();
...
apiInstance.entityProcessMonitorStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityProcessMonitorStatusDescribeGET(callback);
```
...
> Object entityProcessMonitorStatusGET(opts)
...
apiInstance.entityProcessMonitorStatusGET(opts, callback);
```
