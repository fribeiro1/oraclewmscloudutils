# RestApi.EntitypropertyPromptModeApi
...
> Object entityPropertyPromptModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypropertyPromptModeApi();
...
apiInstance.entityPropertyPromptModeByIdGET(id, opts, callback);
```
...
apiInstance.entityPropertyPromptModeDescribeGET(callback);
```
...
> Object entityPropertyPromptModeGET(opts)
...
apiInstance.entityPropertyPromptModeGET(opts, callback);
```
