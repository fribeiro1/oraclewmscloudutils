# RestApi.EntitypurchaseOrderDtlApi
...
> Object entityPurchaseOrderDtlByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypurchaseOrderDtlApi();
...
apiInstance.entityPurchaseOrderDtlByIdGET(id, opts, callback);
```
...
> Object entityPurchaseOrderDtlByIdPATCH(id, opts)
...
apiInstance.entityPurchaseOrderDtlByIdPATCH(id, opts, callback);
```
...
apiInstance.entityPurchaseOrderDtlDescribeGET(callback);
```
...
> Object entityPurchaseOrderDtlGET(opts)
...
apiInstance.entityPurchaseOrderDtlGET(opts, callback);
```
