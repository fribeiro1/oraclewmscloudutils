# RestApi.EntitypurchaseOrderHdrApi
...
> Object entityPurchaseOrderHdrByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypurchaseOrderHdrApi();
...
apiInstance.entityPurchaseOrderHdrByIdGET(id, opts, callback);
```
...
> Object entityPurchaseOrderHdrByIdPATCH(id, opts)
...
apiInstance.entityPurchaseOrderHdrByIdPATCH(id, opts, callback);
```
...
apiInstance.entityPurchaseOrderHdrDescribeGET(callback);
```
...
> Object entityPurchaseOrderHdrGET(opts)
...
apiInstance.entityPurchaseOrderHdrGET(opts, callback);
```
