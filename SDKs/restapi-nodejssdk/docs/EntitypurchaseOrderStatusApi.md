# RestApi.EntitypurchaseOrderStatusApi
...
> Object entityPurchaseOrderStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitypurchaseOrderStatusApi();
...
apiInstance.entityPurchaseOrderStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityPurchaseOrderStatusDescribeGET(callback);
```
...
> Object entityPurchaseOrderStatusGET(opts)
...
apiInstance.entityPurchaseOrderStatusGET(opts, callback);
```
