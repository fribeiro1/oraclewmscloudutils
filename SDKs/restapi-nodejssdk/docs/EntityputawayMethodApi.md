# RestApi.EntityputawayMethodApi
...
> Object entityPutawayMethodByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityputawayMethodApi();
...
apiInstance.entityPutawayMethodByIdGET(id, opts, callback);
```
...
apiInstance.entityPutawayMethodDescribeGET(callback);
```
...
> Object entityPutawayMethodGET(opts)
...
apiInstance.entityPutawayMethodGET(opts, callback);
```
