# RestApi.EntityputawaySearchModeApi
...
> Object entityPutawaySearchModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityputawaySearchModeApi();
...
apiInstance.entityPutawaySearchModeByIdGET(id, opts, callback);
```
...
apiInstance.entityPutawaySearchModeDescribeGET(callback);
```
...
> Object entityPutawaySearchModeGET(opts)
...
apiInstance.entityPutawaySearchModeGET(opts, callback);
```
