...
> Object entityPutawayTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityputawayTypeApi();
...
apiInstance.entityPutawayTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityPutawayTypeGET(callback);
```
...
apiInstance.entityPutawayTypePOST(callback);
```
