# RestApi.EntityreasonCodeTypeApi
...
> Object entityReasonCodeTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityreasonCodeTypeApi();
...
apiInstance.entityReasonCodeTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityReasonCodeTypeDescribeGET(callback);
```
...
> Object entityReasonCodeTypeGET(opts)
...
apiInstance.entityReasonCodeTypeGET(opts, callback);
```
