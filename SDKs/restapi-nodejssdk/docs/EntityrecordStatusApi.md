...
> Object entityRecordStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityrecordStatusApi();
...
apiInstance.entityRecordStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityRecordStatusDescribeGET(callback);
```
...
> Object entityRecordStatusGET(opts)
...
apiInstance.entityRecordStatusGET(opts, callback);
```
