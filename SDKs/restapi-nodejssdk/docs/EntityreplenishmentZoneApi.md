# RestApi.EntityreplenishmentZoneApi
...
> Object entityReplenishmentZoneByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityreplenishmentZoneApi();
...
apiInstance.entityReplenishmentZoneByIdGET(id, opts, callback);
```
...
apiInstance.entityReplenishmentZoneGET(callback);
```
...
apiInstance.entityReplenishmentZonePOST(callback);
```
