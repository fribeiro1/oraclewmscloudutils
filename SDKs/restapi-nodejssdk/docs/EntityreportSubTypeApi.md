# RestApi.EntityreportSubTypeApi
...
> Object entityReportSubTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityreportSubTypeApi();
...
apiInstance.entityReportSubTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityReportSubTypeDescribeGET(callback);
```
...
> Object entityReportSubTypeGET(opts)
...
apiInstance.entityReportSubTypeGET(opts, callback);
```
