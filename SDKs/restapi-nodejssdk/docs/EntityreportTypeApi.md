...
> Object entityReportTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityreportTypeApi();
...
apiInstance.entityReportTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityReportTypeDescribeGET(callback);
```
...
# **entityReportTypeGET**
> Object entityReportTypeGET(opts)
...
apiInstance.entityReportTypeGET(opts, callback);
```
