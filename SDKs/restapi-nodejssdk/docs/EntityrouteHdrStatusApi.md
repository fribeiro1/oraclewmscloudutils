# RestApi.EntityrouteHdrStatusApi
...
> Object entityRouteHdrStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityrouteHdrStatusApi();
...
apiInstance.entityRouteHdrStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityRouteHdrStatusDescribeGET(callback);
```
...
> Object entityRouteHdrStatusGET(opts)
...
apiInstance.entityRouteHdrStatusGET(opts, callback);
```
