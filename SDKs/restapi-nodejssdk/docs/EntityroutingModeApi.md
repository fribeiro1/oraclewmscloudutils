...
> Object entityRoutingModeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityroutingModeApi();
...
apiInstance.entityRoutingModeByIdGET(id, opts, callback);
```
...
apiInstance.entityRoutingModeDescribeGET(callback);
```
...
> Object entityRoutingModeGET(opts)
...
apiInstance.entityRoutingModeGET(opts, callback);
```
