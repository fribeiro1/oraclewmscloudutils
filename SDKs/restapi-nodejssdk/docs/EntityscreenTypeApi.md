...
> Object entityScreenTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityscreenTypeApi();
...
apiInstance.entityScreenTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityScreenTypeDescribeGET(callback);
```
...
# **entityScreenTypeGET**
> Object entityScreenTypeGET(opts)
...
apiInstance.entityScreenTypeGET(opts, callback);
```
