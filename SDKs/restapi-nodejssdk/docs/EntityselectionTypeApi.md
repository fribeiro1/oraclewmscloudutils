# RestApi.EntityselectionTypeApi
...
> Object entitySelectionTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityselectionTypeApi();
...
apiInstance.entitySelectionTypeByIdGET(id, opts, callback);
```
...
apiInstance.entitySelectionTypeDescribeGET(callback);
```
...
> Object entitySelectionTypeGET(opts)
...
apiInstance.entitySelectionTypeGET(opts, callback);
```
