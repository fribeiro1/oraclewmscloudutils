...
> Object entitySeqCounterByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityseqCounterApi();
...
apiInstance.entitySeqCounterByIdGET(id, opts, callback);
```
...
apiInstance.entitySeqCounterDescribeGET(callback);
```
...
# **entitySeqCounterGET**
> Object entitySeqCounterGET(opts)
...
apiInstance.entitySeqCounterGET(opts, callback);
```
