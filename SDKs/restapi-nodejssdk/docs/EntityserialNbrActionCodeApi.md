# RestApi.EntityserialNbrActionCodeApi
...
> Object entitySerialNbrActionCodeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityserialNbrActionCodeApi();
...
apiInstance.entitySerialNbrActionCodeByIdGET(id, opts, callback);
```
...
apiInstance.entitySerialNbrActionCodeDescribeGET(callback);
```
...
> Object entitySerialNbrActionCodeGET(opts)
...
apiInstance.entitySerialNbrActionCodeGET(opts, callback);
```
