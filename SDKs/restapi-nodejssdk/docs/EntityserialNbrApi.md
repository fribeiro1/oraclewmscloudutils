...
> Object entitySerialNbrByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityserialNbrApi();
...
apiInstance.entitySerialNbrByIdGET(id, opts, callback);
```
...
apiInstance.entitySerialNbrDescribeGET(callback);
```
...
# **entitySerialNbrGET**
> Object entitySerialNbrGET(opts)
...
apiInstance.entitySerialNbrGET(opts, callback);
```
