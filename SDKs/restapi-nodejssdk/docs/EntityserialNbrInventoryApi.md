# RestApi.EntityserialNbrInventoryApi
...
> Object entitySerialNbrInventoryByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityserialNbrInventoryApi();
...
apiInstance.entitySerialNbrInventoryByIdGET(id, opts, callback);
```
...
apiInstance.entitySerialNbrInventoryDescribeGET(callback);
```
...
> Object entitySerialNbrInventoryGET(opts)
...
apiInstance.entitySerialNbrInventoryGET(opts, callback);
```
