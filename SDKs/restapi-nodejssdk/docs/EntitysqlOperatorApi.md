...
> Object entitySqlOperatorByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitysqlOperatorApi();
...
apiInstance.entitySqlOperatorByIdGET(id, opts, callback);
```
...
apiInstance.entitySqlOperatorDescribeGET(callback);
```
...
> Object entitySqlOperatorGET(opts)
...
apiInstance.entitySqlOperatorGET(opts, callback);
```
