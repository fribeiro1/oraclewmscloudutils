...
> Object entitySqlSelectionByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitysqlSelectionApi();
...
apiInstance.entitySqlSelectionByIdGET(id, opts, callback);
```
...
apiInstance.entitySqlSelectionGET(callback);
```
...
apiInstance.entitySqlSelectionPOST(callback);
```
