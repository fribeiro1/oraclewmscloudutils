...
> Object entityStageStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitystageStatusApi();
...
apiInstance.entityStageStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityStageStatusDescribeGET(callback);
```
...
> Object entityStageStatusGET(opts)
...
apiInstance.entityStageStatusGET(opts, callback);
```
