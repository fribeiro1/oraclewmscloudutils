...
> Object entityStopStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitystopStatusApi();
...
apiInstance.entityStopStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityStopStatusDescribeGET(callback);
```
...
# **entityStopStatusGET**
> Object entityStopStatusGET(opts)
...
apiInstance.entityStopStatusGET(opts, callback);
```
