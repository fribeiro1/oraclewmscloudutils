...
> Object entityTaskStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitytaskStatusApi();
...
apiInstance.entityTaskStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityTaskStatusDescribeGET(callback);
```
...
# **entityTaskStatusGET**
> Object entityTaskStatusGET(opts)
...
apiInstance.entityTaskStatusGET(opts, callback);
```
