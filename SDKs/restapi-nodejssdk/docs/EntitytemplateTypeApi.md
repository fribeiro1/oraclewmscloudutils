...
> Object entityTemplateTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitytemplateTypeApi();
...
apiInstance.entityTemplateTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityTemplateTypeDescribeGET(callback);
```
...
> Object entityTemplateTypeGET(opts)
...
apiInstance.entityTemplateTypeGET(opts, callback);
```
