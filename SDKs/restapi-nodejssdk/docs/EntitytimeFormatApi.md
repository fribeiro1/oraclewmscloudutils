...
> Object entityTimeFormatByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitytimeFormatApi();
...
apiInstance.entityTimeFormatByIdGET(id, opts, callback);
```
...
apiInstance.entityTimeFormatDescribeGET(callback);
```
...
# **entityTimeFormatGET**
> Object entityTimeFormatGET(opts)
...
apiInstance.entityTimeFormatGET(opts, callback);
```
