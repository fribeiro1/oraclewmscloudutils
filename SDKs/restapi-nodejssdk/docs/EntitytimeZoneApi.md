...
> Object entityTimeZoneByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitytimeZoneApi();
...
apiInstance.entityTimeZoneByIdGET(id, opts, callback);
```
...
apiInstance.entityTimeZoneDescribeGET(callback);
```
...
apiInstance.entityTimeZoneGET(opts, callback);
```
