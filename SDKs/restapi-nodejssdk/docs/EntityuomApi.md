...
# **entityUomByIdGET**
> Object entityUomByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityuomApi();
...
apiInstance.entityUomByIdGET(id, opts, callback);
```
...
apiInstance.entityUomDescribeGET(callback);
```
...
apiInstance.entityUomGET(opts, callback);
```
