# RestApi.EntityupsRoutingCodeApi
...
> Object entityUpsRoutingCodeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityupsRoutingCodeApi();
...
apiInstance.entityUpsRoutingCodeByIdGET(id, opts, callback);
```
...
apiInstance.entityUpsRoutingCodeDescribeGET(callback);
```
...
> Object entityUpsRoutingCodeGET(opts)
...
apiInstance.entityUpsRoutingCodeGET(opts, callback);
```
