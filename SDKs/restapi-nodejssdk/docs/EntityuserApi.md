...
# **entityUserByIdGET**
> Object entityUserByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityuserApi();
...
apiInstance.entityUserByIdGET(id, opts, callback);
```
...
apiInstance.entityUserDescribeGET(callback);
```
...
apiInstance.entityUserGET(opts, callback);
```
