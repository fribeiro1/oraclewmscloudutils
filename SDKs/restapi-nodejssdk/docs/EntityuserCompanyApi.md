...
> Object entityUserCompanyByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityuserCompanyApi();
...
apiInstance.entityUserCompanyByIdGET(id, opts, callback);
```
...
apiInstance.entityUserCompanyDescribeGET(callback);
```
...
> Object entityUserCompanyGET(opts)
...
apiInstance.entityUserCompanyGET(opts, callback);
```
