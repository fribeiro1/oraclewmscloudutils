...
> Object entityUserFacilityByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityuserFacilityApi();
...
apiInstance.entityUserFacilityByIdGET(id, opts, callback);
```
...
apiInstance.entityUserFacilityDescribeGET(callback);
```
...
> Object entityUserFacilityGET(opts)
...
apiInstance.entityUserFacilityGET(opts, callback);
```
