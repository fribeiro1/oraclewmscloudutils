...
> Object entityValueTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityvalueTypeApi();
...
apiInstance.entityValueTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityValueTypeDescribeGET(callback);
```
...
# **entityValueTypeGET**
> Object entityValueTypeGET(opts)
...
apiInstance.entityValueTypeGET(opts, callback);
```
