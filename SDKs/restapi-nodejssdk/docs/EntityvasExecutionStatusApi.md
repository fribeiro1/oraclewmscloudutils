# RestApi.EntityvasExecutionStatusApi
...
> Object entityVasExecutionStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityvasExecutionStatusApi();
...
apiInstance.entityVasExecutionStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityVasExecutionStatusDescribeGET(callback);
```
...
> Object entityVasExecutionStatusGET(opts)
...
apiInstance.entityVasExecutionStatusGET(opts, callback);
```
