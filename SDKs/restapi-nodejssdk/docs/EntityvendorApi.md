...
# **entityVendorByIdGET**
> Object entityVendorByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityvendorApi();
...
apiInstance.entityVendorByIdGET(id, opts, callback);
```
...
> Object entityVendorByIdPATCH(id, opts)
...
apiInstance.entityVendorByIdPATCH(id, opts, callback);
```
...
apiInstance.entityVendorDescribeGET(callback);
```
...
apiInstance.entityVendorGET(opts, callback);
```
