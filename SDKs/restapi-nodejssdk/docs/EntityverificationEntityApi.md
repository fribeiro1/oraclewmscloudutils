# RestApi.EntityverificationEntityApi
...
> Object entityVerificationEntityByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityverificationEntityApi();
...
apiInstance.entityVerificationEntityByIdGET(id, opts, callback);
```
...
apiInstance.entityVerificationEntityDescribeGET(callback);
```
...
> Object entityVerificationEntityGET(opts)
...
apiInstance.entityVerificationEntityGET(opts, callback);
```
