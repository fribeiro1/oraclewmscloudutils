# RestApi.EntityverificationTypeApi
...
> Object entityVerificationTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityverificationTypeApi();
...
apiInstance.entityVerificationTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityVerificationTypeDescribeGET(callback);
```
...
> Object entityVerificationTypeGET(opts)
...
apiInstance.entityVerificationTypeGET(opts, callback);
```
