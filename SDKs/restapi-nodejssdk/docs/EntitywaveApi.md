...
# **entityWaveByIdGET**
> Object entityWaveByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywaveApi();
...
apiInstance.entityWaveByIdGET(id, opts, callback);
```
...
apiInstance.entityWaveDescribeGET(callback);
```
...
apiInstance.entityWaveGET(opts, callback);
```
