...
> Object entityWaveStageByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywaveStageApi();
...
apiInstance.entityWaveStageByIdGET(id, opts, callback);
```
...
apiInstance.entityWaveStageDescribeGET(callback);
```
...
# **entityWaveStageGET**
> Object entityWaveStageGET(opts)
...
apiInstance.entityWaveStageGET(opts, callback);
```
