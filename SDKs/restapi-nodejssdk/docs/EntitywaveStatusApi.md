...
> Object entityWaveStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywaveStatusApi();
...
apiInstance.entityWaveStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityWaveStatusDescribeGET(callback);
```
...
# **entityWaveStatusGET**
> Object entityWaveStatusGET(opts)
...
apiInstance.entityWaveStatusGET(opts, callback);
```
