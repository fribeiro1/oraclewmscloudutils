...
> Object entityWaveTemplateByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywaveTemplateApi();
...
apiInstance.entityWaveTemplateByIdGET(id, opts, callback);
```
...
apiInstance.entityWaveTemplateDescribeGET(callback);
```
...
> Object entityWaveTemplateGET(opts)
...
apiInstance.entityWaveTemplateGET(opts, callback);
```
