# RestApi.EntitywaveTemplateStatusApi
...
> Object entityWaveTemplateStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywaveTemplateStatusApi();
...
apiInstance.entityWaveTemplateStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityWaveTemplateStatusDescribeGET(callback);
```
...
> Object entityWaveTemplateStatusGET(opts)
...
apiInstance.entityWaveTemplateStatusGET(opts, callback);
```
