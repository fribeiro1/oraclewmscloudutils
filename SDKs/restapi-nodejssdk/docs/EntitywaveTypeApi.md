...
> Object entityWaveTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywaveTypeApi();
...
apiInstance.entityWaveTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityWaveTypeDescribeGET(callback);
```
...
apiInstance.entityWaveTypeGET(opts, callback);
```
