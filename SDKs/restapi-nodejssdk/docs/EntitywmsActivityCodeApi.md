# RestApi.EntitywmsActivityCodeApi
...
> Object entityWmsActivityCodeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywmsActivityCodeApi();
...
apiInstance.entityWmsActivityCodeByIdGET(id, opts, callback);
```
...
apiInstance.entityWmsActivityCodeDescribeGET(callback);
```
...
> Object entityWmsActivityCodeGET(opts)
...
apiInstance.entityWmsActivityCodeGET(opts, callback);
```
