# RestApi.EntitywmsActivityStatusApi
...
> Object entityWmsActivityStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntitywmsActivityStatusApi();
...
apiInstance.entityWmsActivityStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityWmsActivityStatusDescribeGET(callback);
```
...
> Object entityWmsActivityStatusGET(opts)
...
apiInstance.entityWmsActivityStatusGET(opts, callback);
```
