# RestApi.EntityworkAreaActivityTypeApi
...
> Object entityWorkAreaActivityTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityworkAreaActivityTypeApi();
...
apiInstance.entityWorkAreaActivityTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityWorkAreaActivityTypeDescribeGET(callback);
```
...
> Object entityWorkAreaActivityTypeGET(opts)
...
apiInstance.entityWorkAreaActivityTypeGET(opts, callback);
```
