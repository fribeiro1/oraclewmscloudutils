# RestApi.EntityworkOrderActivityTypeApi
...
> Object entityWorkOrderActivityTypeByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityworkOrderActivityTypeApi();
...
apiInstance.entityWorkOrderActivityTypeByIdGET(id, opts, callback);
```
...
apiInstance.entityWorkOrderActivityTypeDescribeGET(callback);
```
...
> Object entityWorkOrderActivityTypeGET(opts)
...
apiInstance.entityWorkOrderActivityTypeGET(opts, callback);
```
