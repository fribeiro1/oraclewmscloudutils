# RestApi.EntityworkOrderComponentApi
...
> Object entityWorkOrderComponentByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityworkOrderComponentApi();
...
apiInstance.entityWorkOrderComponentByIdGET(id, opts, callback);
```
...
apiInstance.entityWorkOrderComponentDescribeGET(callback);
```
...
> Object entityWorkOrderComponentGET(opts)
...
apiInstance.entityWorkOrderComponentGET(opts, callback);
```
