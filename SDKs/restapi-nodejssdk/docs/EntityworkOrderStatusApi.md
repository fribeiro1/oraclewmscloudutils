# RestApi.EntityworkOrderStatusApi
...
> Object entityWorkOrderStatusByIdGET(id, opts)
...
var apiInstance = new RestApi.EntityworkOrderStatusApi();
...
apiInstance.entityWorkOrderStatusByIdGET(id, opts, callback);
```
...
apiInstance.entityWorkOrderStatusDescribeGET(callback);
```
...
> Object entityWorkOrderStatusGET(opts)
...
apiInstance.entityWorkOrderStatusGET(opts, callback);
```
